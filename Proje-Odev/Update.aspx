<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Proje_Odev.Update" %>
  ...
  <div class="registerbox">
        <form id="form1" runat="server">
            ...
            <div class="table-hover">
                <h1 class="text-center">Kullanıcı Güncelleme Formu</h1>
                <table class="table">
                    ...
                    <tr>
                        <td class="button"></td>
                        <td>
                            <asp:Button ID="Button1" runat="server" Text="Guncelle" OnClick="Button1_Click" CssClass="btn-block" />
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <asp:Label ID="lbltut" runat="server" Text="Sonuc"></asp:Label>
</body>
</html>
